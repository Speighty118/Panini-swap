  ...
  try {
    const { rows } = await pool.query(
      `SELECT
         ...
         u.founder_member AS other_user_founder_member,
         u.last_login_at AS other_user_last_login_at,
       ...
       GROUP BY c.id, c.created_at, u.id, u.name, u.ambassador_badge, u.founder_member, u.last_login_at, u.profile_photo, lm.body, lm.created_at, lm.sender_id
...
router.get('/:conversationId', async (req, res) => {
  ...
  try {
    ...
    const { rows: otherRows } = await pool.query(
      `SELECT u.id, u.name, u.profile_photo, u.ambassador_badge, u.founder_member, u.last_login_at FROM conversation_participants cp
